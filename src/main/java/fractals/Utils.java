...
public class Utils {
    public static MathContext CONTEXT = new MathContext(64, RoundingMode.HALF_EVEN); //new MathContext(128, RoundingMode.HALF_EVEN);

    public static BigDecimal TWO = new BigDecimal(2, CONTEXT);

    public static int getDecimalFractionLengh(String decimal) {
